...
const Quiz = () => {
  ...
  const setupQuizSecurity = () => {
    ...
    quizSecurity.setupFullscreenSecurity({
      onExit: () => {
        console.log('Fullscreen exited - displaying warning');
        setTimerPaused(true);
  ...
  const enterFullscreenMode = () => {
    ...
    quizSecurity.enterFullscreen(document.documentElement)
      ...
      .catch((err) => {
        ...
        alert('Unable to enter fullscreen mode. Please try again or press F11 to enter fullscreen mode. Fullscreen mode is REQUIRED to take the quiz. You cannot proceed without entering fullscreen mode.');
        // Keep showing the fullscreen prompt if there's an error
        ...
        <div className="fullscreen-initial-message">
          <div className="fullscreen-initial-content">
            ...
            <div className="fullscreen-button-container">
              ...
              <p className="fullscreen-keyboard-shortcut">You can also press <kbd>F11</kbd> to enter fullscreen mode.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="quiz-page">
      ...
      <div className="fullscreen-warning-container" ref={fullscreenWarningRef}>
        <div className="fullscreen-warning">
          <div className="fullscreen-warning-icon">⚠️</div>          <h2 className="fullscreen-warning-title">⚠️ SECURITY VIOLATION: Fullscreen Mode Required ⚠️</h2>
          <p className="fullscreen-warning-message">
            <strong>WARNING: You have exited fullscreen mode!</strong> The quiz timer has been paused 
            and this incident has been logged. You MUST return to fullscreen mode immediately to continue.
          </p>
